...
public class QoAWarrior 
{
  ...
  private int warriorh = 60; //This variable holds the warrior's health
  private int warriora = 50; //This variable holds the warrior's attack
  ...
  private int[] Stats = {warriorh, warriora, gold, level}; //This variable shows whats stored within the array
  ...
  public void intro()//Displays the opening title screen of the game
  {
    System.out.println("WELCOME TO: ");
    System.out.println("    ,o888888o.     8 8888      88 8 8888888888     d888888o. 8888888 8888888888               ,o888888o.     8 8888888888     ");   
    System.out.println(". 8888     `88.   8 8888      88 8 8888         .`8888:' `88.     8 8888                  . 8888     `88.   8 8888            ");
    System.out.println(",8 8888       `8b  8 8888      88 8 8888         8.`8888.   Y8     8 8888                 ,8 8888       `8b  8 8888           ");
    System.out.println("88 8888        `8b 8 8888      88 8 8888         `8.`8888.         8 8888                 88 8888        `8b 8 8888           ");
    System.out.println("88 8888         88 8 8888      88 8 888888888888  `8.`8888.        8 8888                 88 8888         88 8 888888888888   ");
    System.out.println("88 8888     `8. 88 8 8888      88 8 8888           `8.`8888.       8 8888                 88 8888         88 8 8888           ");
    System.out.println("88 8888      `8,8P 8 8888      88 8 8888            `8.`8888.      8 8888                 88 8888        ,8P 8 8888           ");
    System.out.println("`8 8888       ;8P  ` 8888     ,8P 8 8888        8b   `8.`8888.     8 8888                 `8 8888       ,8P  8 8888           ");
    System.out.println(" ` 8888     ,88'8.   8888   ,d8P  8 8888        `8b.  ;8.`8888     8 8888                  ` 8888     ,88'   8 8888           ");
    System.out.println("    `8888888P'  `8.   `Y88888P'   8 888888888888 `Y8888P ,88P'     8 8888                     `8888888P'     8 8888           ");
    System.out.println("                                                                                                                              ");
    System.out.println("8888888 8888888888 8 8888        8 8 8888888888                      .8.           ,o888888o.    8 8888888888     d888888o.   ");
    System.out.println("      8 8888       8 8888        8 8 8888                           .888.         8888     `88.  8 8888         .`8888:' `88. ");
    System.out.println("     8 8888       8 8888        8 8 8888                          :88888.     ,8 8888       `8. 8 8888         8.`8888.   Y8  ");
    System.out.println("     8 8888       8 8888        8 8 8888                         . `88888.    88 8888           8 8888         `8.`8888.      ");
    System.out.println("     8 8888       8 8888        8 8 888888888888                .8. `88888.   88 8888           8 888888888888  `8.`8888.     ");
    System.out.println("     8 8888       8 8888        8 8 8888                       .8`8. `88888.  88 8888           8 8888           `8.`8888.    ");
    System.out.println("     8 8888       8 8888888888888 8 8888                      .8' `8. `88888. 88 8888   8888888 8 8888            `8.`8888.   ");
    System.out.println("     8 8888       8 8888        8 8 8888                     .8'   `8. `88888.`8 8888       .8' 8 8888        8b   `8.`8888.  ");
    System.out.println("     8 8888       8 8888        8 8 8888                    .888888888. `88888.  8888     ,88'  8 8888        `8b.  ;8.`8888  ");
    System.out.println("    8 8888       8 8888        8 8 888888888888           .8'       `8. `88888.  `8888888P'    8 888888888888 `Y8888P ,88P'   ");
    System.out.println("");
    System.out.println("Hit enter to begin the most epic journey of your life. Or if your not ready for the challenge, type 'help' for help.");
    getInput(); //Calls the following method because its more efficent than typing try, readLine and catch 
    if (userinput.equalsIgnoreCase ("help")) //If the user types help, a line will be printed, explaining the basics of the game
    {
      System.out.print("This is the greatest Text-Based RPG you'll ever experience. How this game works is simple. You select your desired character, make your way to the kingdom by defeating or avoiding various enemies and clearing certain events. Between each of the four chapters, an event will occur such as a shop, which can be used to purchase items that increase a certain stat.");
      System.out.print("Items can be purchased from the gold you earn by defeating enemies. Certain enemies reward you with a level increase, resulting in a attack and health increase. You'll rank your way up until your strong enough to take on the the evil dragon attacking the kingdom. If you succeed, you will be rewarded greatly.. maybe.");
      System.out.println("");
      System.out.println("");
    }
  }
  
  public String selectCharacter() //This method allows the user to chose which class they want to play
  { 
    System.out.println("'Tonight's party was epic!. But I'm dead tired. Off to bed.' *You take off all you clothes, put on your favourite Care Bears Pjs and fall asleep*.");
    System.out.println("ZzZzZzZzZzZzZzZ You had way too many shots of Kool-aid and you experienced some weird dreams of you taking on a adventure, saving a kingdom that was under attack by a dragon.");
    System.out.println("*Stretch noises* You get up, rub your eyes, look out the window for some refreshing air, then freak out because you see Jesus. 'Whoo its was just a dream'");
    System.out.println("*More Stretch noises* You get up, rub your eyes, look out the window for some refreshing air, but then again you freak out because Jesus is still there! 'Sweet Jesus! A dream within a dream!'");
    System.out.println("You wake up again, this time in paranoia waiting for something to pop up. You slowly slip off the blankets and look out the window. 'Oh COME ON'. There's a dragon attacking a kingdom in the distance.");
    System.out.println("You slap yourself and realize 'Whoa this isn't a dream'. You get up, go to the bathroom and splash water in your face. You look up at the mirror and see yourself as: ");
    System.out.println("Choose your class: 'Warrior' , 'Tank' or 'Jester'");
    getInput(); //Calls the following method because its more efficent than typing try, readLine and catch
    return userinput; //Returns the user's input to main, therefore main can decide what class the game is going to run on
  }
  ...
  { 
    System.out.println("Yes indeed. You were a brave Warrior in shining... Care Bear Pjs.");
    System.out.println("");
    System.out.println("You wake up as a warrior. You see outside your window that the kingdom is under attack!!!!");
  ...
  {
    if(randomnum1 <= 5) //Checks the random number to see if it belongs in this if statement
    {
  ...
  {
    warriorh = warriorh - treea; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
    
    if(warriorh <= 0) //The if occurs when the user's health variable is 0 or below 0
    {
  ...
  {
    warriorh = warriorh - hashiramaa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  {
    warriorh = warriorh - gollurka; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  {
    warriorh = warriorh - booa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  {
    warriorh = warriorh - vampirebata; //The user's health is subtracted by the enemy's attack variable
    if(warriorh != warriorh) //Only occurs if the user chose to take the horse and both take damage
    { 
  ...
  { 
    warriorh = warriorh - draculaa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  { 
    warriorh = warriorh - redeada; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  { 
    warriorh = warriorh - kingbooa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  { 
    warriorh = warriorh - celljra; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  { 
    warriorh = warriorh - ridleya; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + warriorh); //Displays your current health at the end of that turn
  ...
  public void inflictDamage1() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        treeh = treeh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
    ...
    {
      treeh = treeh - warriora; //The enemy's health is subtracted by the user's attack variable 
      System.out.println("Tree's health: " + treeh); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void inflictDamage2() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        hashiramah = hashiramah - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Hashirama's health: " + hashiramah); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      hashiramah = hashiramah - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Hashirama's health: " + hashiramah); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void inflictDamage3() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        gollurkh = gollurkh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Gollurk's health: " + gollurkh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      gollurkh = gollurkh - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Gollurk's health: " + gollurkh); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void inflictDamage4() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        booh = booh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Boo's health: " + booh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      booh = booh - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Boo's health: " + booh); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        vampirebath = vampirebath - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Vampire's health: " + vampirebath); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      vampirebath = vampirebath - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Vampire's health: " + vampirebath); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        draculah = draculah - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Dracula's health: " + draculah); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      draculah = draculah - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Dracula's health: " + draculah); //Displays the enemy's current health at the end of that turn
    }
  ...
  {  
    ...
    { 
      ...
      {
        redeadh = redeadh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Redead's health: " + redeadh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      redeadh = redeadh - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Redead's health: " + redeadh); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        kingbooh = kingbooh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("King Boo's health: " + kingbooh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      kingbooh = kingbooh - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("King Boo's health: " + kingbooh); //Displays the enemy's current health at the end of that turn
    }
  ...
  {   
    ...
    { 
      ...
      {
        celljrh = celljrh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Cell Jr's health: " + celljrh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      celljrh = celljrh - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Cell Jr's health: " + celljrh); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        ridleyh = ridleyh - warriora; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Ridley's health: " + ridleyh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      ridleyh = ridleyh - warriora; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Ridley's health: " + ridleyh); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void forestShop()
  {
    ...
    warriora = 70; //Sets the user's new attack after leveling up from the boss
    warriorh = 100; //Sets the user's new health after leveling up from the boss
    System.out.println("Your attack is " + warriora + ". Your health is " + warriorh); //Displays the users current attack and health
    ...
    if(userinput.equalsIgnoreCase("Assault vest")) //User will type assault vest if they wish to upgrade their health
    {
      if(gold >= 10) //If the user wants to make a purchase and they have enough gold
      {
        ...
        warriorh = warriorh + 10; //Adds the assault vest's health stat to the user overall health stat
        System.out.println("Your health is now: " + warriorh); //Displays the user's new health stat
      } 
    ...
    else if(userinput.equalsIgnoreCase("Quick claw")) //User will type quick claw if they wish to upgrade their attack
    {
      ...
      {
        gold = gold - 10; //User makes the purchase and the user's gold is subtracted by the cost of the item
        warriora = warriora + 10; //Adds the quick claw's attack stat to the user overall attack stat
        System.out.println("Your attack is now: " + warriora);//Displays the user's new attack stat
      } 
      else //If the user has insufficient gold to make the purchase
      {
        System.out.println("That's 10 gold silly. You only have: " + gold + " gold."); //Displays how much gold the user currently has
  ...
  public void caveLeft() //This is another cave left the user can go through
  {
    ...
    else if(randomnum1 >= 6) //Checks if the random number fits here and the user takes damage
    {
      ...
      warriorh = warriorh - 10; //User's health is subtracted by a small amount from the trap
    } 
  }
  ...
  public void caveLeft1() //This is the first cave left the user can go through
  {
    ...
    {
      warriorh = 110; //Declares the user's new health stat
    }
    else if(quickclaw == 0) //If the user bought the quick claw
    {
      warriorh = 100; //Declares the user's new health stat
    }
  ...
  public void caveRight1() // The method calls the first fork in the cave
  {
    ...
    if(userinput.equalsIgnoreCase ("yes")) //If the user types yes this will occur
    {
      ...
      else if(gold >= 5) //If the user wants to make a bet and they have enough gold
      {
        ...
        if(randomnum1 <= 5) //Checks the random number to see if the user won the gamble 
        {
  ...
  public void caveCenter3() //This is a method where the user gets to try and avoid a trap
  {
    ...
    { 
      ...
      warriorh = 0; //The characters health gets set and 0 and you are dead
      System.out.println("GAME OVER");
  ...
  public void caveBoss1() //This is one of two methods for the cave boss
  {
    ...
    warriorh = warriorh + 100; //User is rewarded with a health boost
    if(quickclaw == 0) //If the user bought the quick claw
    {
      warriora = 100; //Declares the user's new attack stat
    }
    else if(quickclaw == 1) //If the user didn't buy the quick claw
    {
      warriora = 90; //Declares the user's new attack stat
    } 
    System.out.println("Your health is now " + warriorh + " Your attack is now " + warriora);
  ...
  public void villageIntro() //The user enters the third and second last chapter
  {
    if(level == 2) //This will happen once the boss is killed
    {
      if(assaultvest == 0) //If the user bought the assault vest
      {
        warriorh = 160; //Declares the user's new health stat
      }
      else if(assaultvest == 1) //If the user didn't buy the assault vest
      {
        warriorh = 150; //Declares the user's new health stat
      }
      
      if(quickclaw == 0) //If the user bought the quick claw
      {
        warriora = 130; //Declares the user's new attack stat
      }
      else if(quickclaw == 1) //If the user didn't buy the quick claw
      {
        warriora = 120; //Declares the user's new attack stat
      }
    }
    System.out.println("You have been replenshied by the Gods.");
    System.out.println("Your health is now " + warriorh + ". Your attack is now " + warriora + "."); //Displays the user's updated health and attack stats
  ...
  public void castleIntro() //The user enter the fourth and final chapter
  {
    if(level == 3) //Once you kill the boss you level up, and your health and attack stats will change
    {
      ...
      {
        warriorh = 260; //Declares the user's new health stat
      }
      else if(assaultvest == 1) //If the user didn't buy the assault vest this will happen
      {
        warriorh = 250; //Declares the user's new health stat
      }
      
      if(quickclaw == 0) //If the user bought the quick claw this will happen
      {
        warriora = 170; //Declares the user's new attack stat
      }
      else if(quickclaw == 1) //If the user didn't buy the quick claw this will happen
      {
        warriora = 160; //Declares the user's new attack stat
      }
    }
    System.out.println("Your health is " + warriorh + " Your attack is " + warriora); //Displays the user's current stats
  ...
  public void castleLeft() //If the user wants to take the left path
  {
    ...
    if(level == 4) //This will go up if you defeat the next boss
    {
      if(assaultvest == 0) //If the user bought the assault vest this will happen
      {
        warriorh = 310; //Declares the user's new health stat
      }
      else if(assaultvest == 1) //If the user didn't buy the assault vest
      {
        warriorh = 300; //Declares the user's new health stat
      }
      
      if(quickclaw == 0) //If the user bought the quick claw
      {
        warriora = 190; //Declares the user's new attack stat
      }
      else if(quickclaw == 1) //If the user didn't buy the quick claw
      {
        warriora = 180; //Declares the user's new attack stat
      }
    }
  }
  ...
  public void castleRight() //If the user wants to take the right path
  {
    ...
    if(level == 4) //This will go up if you defeat the next boss
    {
      ...
      {
        warriorh = 290; //Declares the user's new health stat
      }
  ...
  public void castleShop() //A shop where the user is fully restored the final boss and is allowed to use their gold to upgrade their stats
  {
    ...
    System.out.println("Your attack is " + warriora + ". Your health is " + warriorh); //Displays what is your current attack and health stat before entering the shop
    ...
    if(userinput.equalsIgnoreCase("patty")) //User will type patty if they wish to upgrade their health
    {
      if(gold >= 40) //If the user wants to make a purchase and they have enough gold
      {
        ...
        warriorh = warriorh + 30; //Adds the patty's health stat to the user overall health stat
        System.out.println("Your health is now: " + warriorh); //Displays the user's new health stat
      } 
      else //If the user has insufficient gold to make the purchase
      {
    ...
    else if(userinput.equalsIgnoreCase("knife")) //User will type knife if they wish to upgrade their atack
    {
      ...
      {
        gold = gold - 40; //User makes the purchase and the user's gold is subtracted by the cost of the item
        warriora = warriora + 20; //Adds the knife's attack stat to the user overall attack stat
        System.out.println("Your attack is now: " + warriora); //Displays the user's new attack stat
      } 
      else //If the user has insufficient gold to make the purchase
      {
  ...
  {
    Stats[0] = warriorh; //Sets the warrior's health variable into the array
    Stats[1] = warriora; //Sets the warrior's attack variable into the array
  ...
  public boolean sideQuit() //THIS IS TO COVER UP OUR DESIGN ERROR. When the user dies, this 'checkpoint' checks flag between each chapter to see if the user can continue  
  {
    ...
    { 
      if(warriorh <= 0) //However, if the user has died but tries to continue playing, the program will know the user is dead
      {
