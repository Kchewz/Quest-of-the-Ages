...
public class QoATank 
{
  ...
  private int tankh = 80; //This variable holds the warrior's health
  private int tanka = 60; //This variable holds the warrior's attack
  ...
  private int[] Stats = {tankh, tanka, gold, level}; //This variable shows whats stored within the array
  ...
  { 
    System.out.println("Yes you were a bulky Tank with the body of Gragas... in Care Bear Pjs.");
    System.out.println("");
    System.out.println("You wake up as a tank. You see outside your window that the kingdom is under attack!!!!");
    System.out.println("In the spur of the moment, you run out of your house and run straight to The Forest of Trees.");
    System.out.println("At the beginning of the forest you come across different paths branching off. Which path do you chose? Left or right?");
  ...
  {
    if(randomnum1 == 1) //Checks the random number to see if it belongs in this if statement
    {
  ...
  {
    tankh = tankh - treea; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
    
    if(tankh <= 0) //The if occurs when the user's health variable is 0 or below 0
    {
  ...
  {
    tankh = tankh - hashiramaa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  {
    tankh = tankh - gollurka; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  {
    tankh = tankh - booa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  {
    tankh = tankh - vampirebata; //The user's health is subtracted by the enemy's attack variable
    if(tankh != tankh) //Only occurs if the user chose to take the horse and both take damage
    { 
  ...
  { 
    tankh = tankh - draculaa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  { 
    tankh = tankh - redeada; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  { 
    tankh = tankh - kingbooa; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  { 
    tankh = tankh - celljra; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  { 
    tankh = tankh - ridleya; //The user's health is subtracted by the enemy's attack variable
    System.out.println("Your health: " + tankh); //Displays your current health at the end of that turn
  ...
  public void inflictDamage1() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        treeh = treeh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
    ...
    {
      treeh = treeh - tanka; //The enemy's health is subtracted by the user's attack variable 
      System.out.println("Tree's health: " + treeh); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void inflictDamage2() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        hashiramah = hashiramah - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Hashirama's health: " + hashiramah); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      hashiramah = hashiramah - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Hashirama's health: " + hashiramah); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void inflictDamage3() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        gollurkh = gollurkh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Gollurk's health: " + gollurkh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      gollurkh = gollurkh - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Gollurk's health: " + gollurkh); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void inflictDamage4() //Luck is on the user's side and they deal damage
  {
    ...
    { 
      ...
      {
        booh = booh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Boo's health: " + booh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      booh = booh - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Boo's health: " + booh); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        vampirebath = vampirebath - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Vampire's health: " + vampirebath); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      vampirebath = vampirebath - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Vampire's health: " + vampirebath); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        draculah = draculah - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Dracula's health: " + draculah); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      draculah = draculah - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Dracula's health: " + draculah); //Displays the enemy's current health at the end of that turn
    }
  ...
  {  
    ...
    { 
      ...
      {
        redeadh = redeadh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Redead's health: " + redeadh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      redeadh = redeadh - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Redead's health: " + redeadh); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        kingbooh = kingbooh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("King Boo's health: " + kingbooh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      kingbooh = kingbooh - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("King Boo's health: " + kingbooh); //Displays the enemy's current health at the end of that turn
    }
  ...
  {   
    ...
    { 
      ...
      {
        celljrh = celljrh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Cell Jr's health: " + celljrh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      celljrh = celljrh - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Cell Jr's health: " + celljrh); //Displays the enemy's current health at the end of that turn
    }
  ...
  { 
    ...
    { 
      ...
      {
        ridleyh = ridleyh - tanka; //The enemy's health is subtracted by the user's attack variable 3 times
        System.out.println("Ridley's health: " + ridleyh); //Displays the enemy's current health at the end of that turn
      }
    } 
    else //Performs a normal single attack
    {
      ridleyh = ridleyh - tanka; //The enemy's health is subtracted by the user's attack variable
      System.out.println("Ridley's health: " + ridleyh); //Displays the enemy's current health at the end of that turn
    }
  ...
  public void forestShop()
  {
    ...
    tanka = 80; //Sets the user's new attack after leveling up from the boss
    tankh = 120; //Sets the user's new health after leveling up from the boss
    System.out.println("Your attack is " + tanka + ". Your health is " + tankh); //Displays the users current attack and health
    ...
    if(userinput.equalsIgnoreCase("Assault vest")) //User will type assault vest if they wish to upgrade their health
    {
      if(gold >= 10) //If the user wants to make a purchase and they have enough gold
      {
        ...
        tankh = tankh + 10; //Adds the assault vest's health stat to the user overall health stat
        System.out.println("Your health is now: " + tankh); //Displays the user's new health stat
      } 
    ...
    else if(userinput.equalsIgnoreCase("Quick claw")) //User will type quick claw if they wish to upgrade their attack
    {
      ...
      {
        gold = gold - 10; //User makes the purchase and the user's gold is subtracted by the cost of the item
        tanka = tanka + 10; //Adds the quick claw's attack stat to the user overall attack stat
        System.out.println("Your attack is now: " + tanka);//Displays the user's new attack stat
      } 
      else //If the user has insufficient gold to make the purchase
      {
        System.out.println("That's 10 gold silly. You only have: " + gold + " gold."); //Displays how much gold the user currently has
  ...
  public void caveLeft() //This is another cave left the user can go through
  {
    ...
    else if(randomnum1 >= 6) //Checks if the random number fits here and the user takes damage
    {
      ...
      tankh = tankh - 10; //User's health is subtracted by a small amount from the trap
    } 
  }
  ...
  public void caveLeft1() //This is the first cave left the user can go through
  {
    ...
    {
      tankh = 130; //Declares the user's new health stat
    }
    else if(quickclaw == 0) //If the user bought the quick claw
    {
      tankh = 120; //Declares the user's new health stat
    }
  ...
  public void caveRight1() // The method calls the first fork in the cave
  {
    ...
    if(userinput.equalsIgnoreCase ("yes")) //If the user types yes this will occur
    {
      ...
      else if(gold >= 5) //If the user wants to make a bet and they have enough gold
      {
        ...
        if(randomnum1 == 1) //Checks the random number to see if the user won the gamble 
        {
  ...
  public void caveCenter3() //This is a method where the user gets to try and avoid a trap
  {
    ...
    { 
      ...
      tankh = 0; //The characters health gets set and 0 and you are dead
      System.out.println("GAME OVER");
  ...
  public void caveBoss1() //This is one of two methods for the cave boss
  {
    ...
    tankh = tankh + 100; //User is rewarded with a health boost
    if(quickclaw == 0) //If the user bought the quick claw
    {
      tanka = 110; //Declares the user's new attack stat
    }
    else if(quickclaw == 1) //If the user didn't buy the quick claw
    {
      tanka = 100; //Declares the user's new attack stat
    } 
    System.out.println("Your health is now " + tankh + " Your attack is now " + tanka);
  ...
  public void villageIntro() //The user enters the third and second last chapter
  {
    if(level == 2) //This will happen once the boss is killed
    {
      if(assaultvest == 0) //If the user bought the assault vest
      {
        tankh = 180; //Declares the user's new health stat
      }
      else if(assaultvest == 1) //If the user didn't buy the assault vest
      {
        tankh = 170; //Declares the user's new health stat
      }
      
      if(quickclaw == 0) //If the user bought the quick claw
      {
        tanka = 120; //Declares the user's new attack stat
      }
      else if(quickclaw == 1) //If the user didn't buy the quick claw
      {
        tanka = 110; //Declares the user's new attack stat
    ...
    System.out.println("Your health is now " + tankh + ". Your attack is now " + tanka + "."); //Displays the user's updated health and attack stats
  ...
  public void castleIntro() //The user enter the fourth and final chapter
  {
    if(level == 3) //Once you kill the boss you level up, and your health and attack stats will change
    {
      ...
      {
        tankh = 280; //Declares the user's new health stat
      }
      else if(assaultvest == 1) //If the user didn't buy the assault vest this will happen
      {
        tankh = 270; //Declares the user's new health stat
      }
      
      if(quickclaw == 0) //If the user bought the quick claw this will happen
      {
        tanka = 160; //Declares the user's new attack stat
      }
      else if(quickclaw == 1) //If the user didn't buy the quick claw this will happen
      {
        tanka = 150; //Declares the user's new attack stat
      }
    }
    System.out.println("Your health is " + tankh + " Your attack is " + tanka); //Displays the user's current stats
  ...
  public void castleLeft() //If the user wants to take the left path
  {
    ...
    if(level == 4) //This will go up if you defeat the next boss
    {
      if(assaultvest == 0) //If the user bought the assault vest this will happen
      {
        tankh = 330; //Declares the user's new health stat
      }
      else if(assaultvest == 1) //If the user didn't buy the assault vest
      {
        tankh = 320; //Declares the user's new health stat
      }
      
      if(quickclaw == 0) //If the user bought the quick claw
      {
        tanka = 190; //Declares the user's new attack stat
      }
      else if(quickclaw == 1) //If the user didn't buy the quick claw
      {
        tanka = 180; //Declares the user's new attack stat
      }
    }
  }
  ...
  public void castleRight() //If the user wants to take the right path
  {
    ...
    if(level == 4) //This will go up if you defeat the next boss
    {
      ...
      {
        tankh = 310; //Declares the user's new health stat
      }
      ...
      {
        tanka = 170; //Declares the user's new attack stat
      }
    }
  }
  ...
  public void castleShop() //A shop where the user is fully restored the final boss and is allowed to use their gold to upgrade their stats
  {
    ...
    System.out.println("Your attack is " + tanka + ". Your health is " + tankh); //Displays what is your current attack and health stat before entering the shop
    ...
    if(userinput.equalsIgnoreCase("patty")) //User will type patty if they wish to upgrade their health
    {
      if(gold >= 40) //If the user wants to make a purchase and they have enough gold
      {
        ...
        tankh = tankh + 30; //Adds the patty's health stat to the user overall health stat
        System.out.println("Your health is now: " + tankh); //Displays the user's new health stat
      } 
      else //If the user has insufficient gold to make the purchase
      {
    ...
    else if(userinput.equalsIgnoreCase("knife")) //User will type knife if they wish to upgrade their atack
    {
      ...
      {
        gold = gold - 40; //User makes the purchase and the user's gold is subtracted by the cost of the item
        tanka = tanka + 20; //Adds the knife's attack stat to the user overall attack stat
        System.out.println("Your attack is now: " + tanka); //Displays the user's new attack stat
      } 
      else //If the user has insufficient gold to make the purchase
      {
  ...
  {
    Stats[0] = tankh; //Sets the warrior's health variable into the array
    Stats[1] = tanka; //Sets the warrior's attack variable into the array
  ...
  public boolean sideQuit() //THIS IS TO COVER UP OUR DESIGN ERROR. When the user dies, this 'checkpoint' checks flag between each chapter to see if the user can continue  
  {
    ...
    { 
      if(tankh <= 0) //However, if the user has died but tries to continue playing, the program will know the user is dead
      {
